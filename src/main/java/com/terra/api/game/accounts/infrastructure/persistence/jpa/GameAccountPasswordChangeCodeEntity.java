...
@Entity
@Table(
        name = "game_account_password_change_code",
        uniqueConstraints = @UniqueConstraint(
                name = "uk_game_account_password_change_code_account",
                columnNames = {"account_id"}
        )
)
public class GameAccountPasswordChangeCodeEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "game_account_password_change_code_id")
    private Long id;
