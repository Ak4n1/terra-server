...
public class EmailTemplateService {
    ...
    public EmailMessage buildGameAccountCreationCodeMessage(String email,
                                                            String code,
                                                            String dashboardUrl,
                                                            SupportedLanguage language,
                                                            long expirationMinutes) {
        String title = messageResolver.getFromModule(
                GAME_ACCOUNT_CREATE_MODULE,
                "mail.game_account_create.subject",
                language
        );
        String subject = buildSubject(
                GAME_ACCOUNT_CREATE_MODULE,
                "mail.game_account_create.subject_label",
                language
        );
        String htmlBody = buildGameAccountCreateLayout(
                messageResolver.getFromModule(GAME_ACCOUNT_CREATE_MODULE, "mail.game_account_create.eyebrow", language),
                title,
                ...
                dashboardUrl,
                messageResolver.getFromModule(GAME_ACCOUNT_CREATE_MODULE, "mail.game_account_create.expiry", language, expirationMinutes),
                messageResolver.getFromModule(GAME_ACCOUNT_CREATE_MODULE, "mail.game_account_create.ignore", language),
                messageResolver.getFromModule(GAME_ACCOUNT_CREATE_MODULE, "mail.common.link_fallback", language),
    ...
    private String buildGameAccountCreateLayout(String eyebrow,
        ...
        return new StringBuilder()
                ...
                .append("<tr><td style=\"padding: 0 0 18px; font-family: Arial, Helvetica, sans-serif; font-size: 34px; font-weight: 700; line-height: 1; letter-spacing: 0.02em; color: #111111; text-transform: uppercase;\">")
                .append("<span style=\"color: #e08821;\">L2</span> Terra")
                .append("</td></tr>")
                .append("<tr><td style=\"border: 1px solid #3a3a3a; background-color: #131313; padding: 0;\">")
                .append("<table role=\"presentation\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" width=\"100%\" style=\"width: 100%; border-collapse: collapse;\">")
                .append("<tr><td style=\"padding: 30px 32px 18px; border-bottom: 1px solid #2a2a2a;\">")
                ...
                .append("</h1></td></tr>")
                .append("<tr><td style=\"padding: 28px 32px 16px;\">")
                ...
                .append("</div></td></tr>")
                .append("<tr><td align=\"center\" style=\"padding: 2px 32px 20px;\">")
                .append("<table role=\"presentation\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\"border-collapse: collapse;\">")
                .append("<tr><td align=\"center\" style=\"border: 1px solid #b56d19; background-color: #131313;\">")
                .append("<a href=\"")
                .append(escapeHtml(dashboardUrl))
                .append("\" style=\"display: inline-block; padding: 12px 24px; color: #e08821; font-family: Arial, Helvetica, sans-serif; font-size: 13px; font-weight: 700; line-height: 1.2; text-align: center; text-decoration: none; text-transform: uppercase; letter-spacing: 0.08em;\">")
                .append(escapeHtml(ctaLabel))
                .append("</a>")
                .append("</td></tr></table></td></tr>")
                .append("<tr><td style=\"padding: 0 32px 8px;\">")
                .append("<p style=\"margin: 0 0 12px; color: #525252; font-family: Arial, Helvetica, sans-serif; font-size: 14px; line-height: 1.7;\">")
                .append(escapeHtml(expiryNote))
                .append("</p>")
                .append("<p style=\"margin: 0 0 12px; color: #525252; font-family: Arial, Helvetica, sans-serif; font-size: 14px; line-height: 1.7;\">")
                .append(escapeHtml(ignoreNote))
                .append("</p></td></tr>")
                .append("<tr><td style=\"padding: 8px 32px 0;\">")
                ...
                .append("</p></td></tr>")
                .append("<tr><td style=\"padding: 18px 32px 28px; border-top: 1px solid #2a2a2a;\">")
