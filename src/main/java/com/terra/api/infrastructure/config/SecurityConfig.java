...
import com.terra.api.security.infrastructure.filter.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public AuthenticationManager authenticationManager(AccountMasterDetailsService accountMasterDetailsService) {
        DaoAuthenticationProvider authenticationProvider = new DaoAuthenticationProvider(accountMasterDetailsService);
