...
public class MessageResolver {
    ...
    private String resolveGameModule(String key) {
        if (key.startsWith("game.change_password.")) {
            return "game/change-password";
        }
        return "game/create-account";
    }
